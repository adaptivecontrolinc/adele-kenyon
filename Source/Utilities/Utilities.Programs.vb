Partial Public Class Utilities
  Partial Public Class Programs
    ...
    Public Shared Function CheckFirstUseOfCommand(ByVal commandCodeToCheck As String, ByVal currentStep As Integer, ByVal programs As String) As Boolean
    ...
    Public Shared Function GetProgramSteps(ByVal program As String) As String()
      Try
        'These separators are used by programs and prefixed steps
        Dim LineFeed As String = Convert.ToChar(13) & Convert.ToChar(10)
        Dim separator1 As String = Convert.ToChar(255)
    ...
    Public Shared Function GetStepParameters(ByVal programStep As String) As String()
      Try
        Dim LineFeed As String = Convert.ToChar(13) & Convert.ToChar(10)
        Dim separator1 As String = Convert.ToChar(255)
        Dim separator2 As String = ","
    ...
    Public Shared Function GetBatchParameters(ByVal parameters As String) As String()
      Try
        'These separators are used by programs and prefixed steps
        Dim LineFeed As String = Convert.ToChar(13) & Convert.ToChar(10)
        Dim separator1 As String = Convert.ToChar(255)
    ...
    Public Shared Function GetCallOffNumber(ByVal currentStep As Integer, ByVal programs As String) As Integer
      ...
      Try
        ...
        For i As Integer = 0 To programSteps.GetUpperBound(0)
          ...
          If CommandString.Length >= 2 Then
            CommandCode = CommandString.Substring(0, 2).ToUpper
            If (CommandCode = "KP") OrElse (CommandCode = "DS") OrElse (CommandCode = "KF") Then
    ...
    Public Shared Function GetCallOffNumber(ByVal Controlcode As ControlCode) As Integer
      'Check to see what calloff is active based on add prepare commands
      Try
