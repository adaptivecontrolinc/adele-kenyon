...
#End If
  ...
  'Added 2013-05-06
  Public Class ProgressBarVertical
  ...
  'Added 2013-05-06 - Vertical Progress bar with color
  'http://support.microsoft.com/?scid=kb;EN-US;323088
  Public Class ProgressBarVerticalColor
    Inherits System.Windows.Forms.ProgressBar
    ...
    Protected Overloads Overrides Sub OnPaint(ByVal e As PaintEventArgs)
      ...
      If Orientation = Windows.Forms.Orientation.Vertical Then
        ...
        rect.Height = CInt(rect.Height * percent)
    ...
    Public Overloads Property Minimum() As Integer
      Get
        Return min
      End Get
    ...
    Public Overloads Property Value() As Integer
      ...
      Set(ByVal Value As Integer)
        ...
        If Orientation = Windows.Forms.Orientation.Vertical Then
          ...
          newValueRect.Height = CInt(newValueRect.Height * percent)

          ' Use an old value to calculate the rectangle for progress.
          percent = CDec((oldValue - min) / (max - min))
          oldValueRect.Height = CInt(oldValueRect.Height * percent)

          ' Find only the part of the screen that must be updated.
          If (newValueRect.Height > oldValueRect.Height) Then
    ...
    Public Overloads Property ProgressBarColor() As Color
      Get
        Return barColor
      End Get
    ...
    Private Sub Draw3DBorder(ByVal g As Graphics)
      ...
      If Orientation = Windows.Forms.Orientation.Vertical Then
        g.DrawLine(Pens.DarkGray, _
            ...
            New Point(Me.ClientRectangle.Height - PenWidth, Me.ClientRectangle.Top))
        g.DrawLine(Pens.DarkGray, _
            New Point(Me.ClientRectangle.Left, Me.ClientRectangle.Top), _
        ...
        g.DrawLine(Pens.White, _
            ...
            New Point(Me.ClientRectangle.Height - PenWidth, Me.ClientRectangle.Height - PenWidth))
        g.DrawLine(Pens.White, _
            New Point(Me.ClientRectangle.Height - PenWidth, Me.ClientRectangle.Top), _
            New Point(Me.ClientRectangle.Height - PenWidth, Me.ClientRectangle.Height - PenWidth))
      Else
        g.DrawLine(Pens.DarkGray, _
            New Point(Me.ClientRectangle.Left, Me.ClientRectangle.Top), _
    ...
    Private orientation_ As Orientation = Orientation.Vertical
    <Category("Appearance"), Description("Control's orientation"), DefaultValue(GetType(Orientation), "Vertical")> _
    Public Property Orientation() As Orientation
      Get
        Return orientation_
    ...
    'another method: http://msdn.microsoft.com/en-us/library/system.windows.forms.progressbarrenderer.aspx
...
#End If
  ...
  ' -----------------------------------------------------
  <Drawing.ToolboxBitmap(GetType(Lamp)), DefaultBindingPropertyAttribute("Value")> _
