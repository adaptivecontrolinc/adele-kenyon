Public Class KeysQwerty : Inherits UserControl
  ...
  Dim keys() As String = {"1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "+",
                          "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "%",
  ...
  Private Sub InitializeControl()
    For i As Integer = keys.GetLowerBound(0) To keys.GetUpperBound(0)
      ...
      Me.Controls.Add(key)
    Next
    ActiveControl = Me.Controls("buttonSpace")
  End Sub
  ...
  Private Sub ToggleCaps()
    Try
      For Each button As KeyNoFocus In Me.Controls
        With button
