Public Class LabelValue : Inherits Control
  ...
  Protected Overrides Sub OnPaint(e As PaintEventArgs)
    ...
    Using myBrush As New Drawing.SolidBrush(ForeColor)
      ...
      e.Graphics.DrawString(Text, Font, myBrush, e.ClipRectangle, sfLeft)
      e.Graphics.DrawString(Value, Font, myBrush, e.ClipRectangle, sfRight)
    End Using
  End Sub
